...
public class MyJedisCluster extends JedisCluster {
	...
	public MyJedisCluster(Set<HostAndPort> hostAndPort) {
		super(hostAndPort);
	}

	public MyJedisCluster(Set<HostAndPort> hostAndPort, GenericObjectPoolConfig conf) {
		super(hostAndPort, conf);
	}

	public MyJedisCluster(Set<HostAndPort> hostAndPort, int timeout) {
		super(hostAndPort, timeout);
	}

	public MyJedisCluster(Set<HostAndPort> hostAndPort, int timeout, int maxRedirections) {
		super(hostAndPort, timeout, maxRedirections);
	}

	public MyJedisCluster(Set<HostAndPort> hostAndPort, int timeout, GenericObjectPoolConfig conf) {
		super(hostAndPort, timeout, conf);
	}

	public MyJedisCluster(Set<HostAndPort> hostAndPort, int timeout, int maxRedirections,
			GenericObjectPoolConfig conf) {
		super(hostAndPort, timeout, maxRedirections, conf);
	}
